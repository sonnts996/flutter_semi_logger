          ...
          children: [
            ...
            ListTile(
              ...
              onTap: () => SemiLogger().custom(const [
                ...
                SemiLogContent('o',  bg: ANSIStyles.yellow,),
                SemiLogContent(' ',  bg: ANSIStyles.yellow,),
                SemiLogContent('Wo', color: ANSIStyles.yellow),
                SemiLogContent('r', color: ANSIStyles.green, fontStyle: ANSIStyles.bold),
                SemiLogContent('ld', color: ANSIStyles.red, bg: ANSIStyles.bgBlue, fontStyle: ANSIStyles.underline),
                SemiLogContent('!', bg: ANSIStyles.bgBlue, fontStyle: ANSIStyles.underline),
              ], separator: ''),
            )
          ],
        ),
